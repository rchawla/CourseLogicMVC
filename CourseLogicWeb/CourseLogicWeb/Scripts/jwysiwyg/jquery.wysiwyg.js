...
(function ($) {
    ...
    $.fn.wysiwyg = function (options) {
        ...
        */
        ...
        if ($.browser.msie) {
            options = $.extend({
                html: '<' + '?xml version="1.0" encoding="UTF-8"?' + '><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">STYLE_SHEET</head><body style="margin: 0px;width:100%; font-family:Helvetica, Arial, sans-serif;color:#333333;font-size:12px;overflow-y:auto;">INITIAL_CONTENT</body></html>',
                css: {},
                debug: false,
            ...
            options = $.extend({
                html: '<' + '?xml version="1.0" encoding="UTF-8"?' + '><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">STYLE_SHEET</head><body style="margin: 0px;width:100%; font-family:Helvetica, Arial, sans-serif;color:#333333;font-size:12px;overflow-x:hidden;overflow-y:auto;">INITIAL_CONTENT</body></html>',
                css: {},
                debug: false,
                autoSave: true,  // http://code.google.com/p/jwysiwyg/issues/detail?id=11
                rmUnwantedBr: true,  // http://code.google.com/p/jwysiwyg/issues/detail?id=15
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        initFrame: function () {
            ...
            */
            ...
            //this.editorDoc.contentEditable = 'false';
