                ...
                getTimeslotTimes: function (date) {
                    ...
                    for (var i = 0; i < options.timeslotsPerDay; i++) {
                        ...
                        times[i] = {
                            ...
                            startFormatted: formatDate(new Date(startMillis), options.timeFormat.rest),
                            end: new Date(endMillis),
                            endFormatted: formatDate(new Date(endMillis), options.timeFormat.rest)
                        };
            ...
            for (i = 0; i < segCnt; i++) {
				...
				* dis + (rtl ? availWidth - outerWidth : 0);   // rtl
				...
				"<div class='" + className + event.className.join(' ') + "' style='position:absolute;z-index:8;top:" + top + "px;left:" + left + "px'>" +
					"<a id=cal " + (event.url ? " href='" + htmlEscape(event.url) + "'" : '') + ">" +
